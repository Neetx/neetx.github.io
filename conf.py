...
BLOG_AUTHOR = "Neetx"  # (translatable)
BLOG_TITLE = "Neetx website"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://neetx.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://neetx.github.io/"
BLOG_EMAIL = "neetx@protonmail.com"
BLOG_DESCRIPTION = "This is a collection of my studies and experiments"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
    	("/", "Home"),
    	("/categories/cat_exploit-development/", "Exploit Development"),
    	("/categories/cat_reverse-engineering", "Reverse Engineering"),
        ("/categories/cat_operational-security", "Operational Security"),
...
#second argument is empty to have the pages in the root dir
PAGES = (
...
CATEGORY_DESCRIPTIONS = {
   DEFAULT_LANG: {
       "Exploit Development": "In this section I will post my experiments in the exploit development field.",
       "Reverse Engineering": "In this section I will post my experiments in the reverse engineering field."
   },
}
...
# Create per-month archives instead of per-year INDEX_PATH
